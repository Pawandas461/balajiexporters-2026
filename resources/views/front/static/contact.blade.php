                ...
                <div class="row g-5">
                        ...
                        <div class="pe-lg-4">
                            ...
                            <div class="contact-info-list d-flex flex-column gap-4">
                                ...
                                <div class="contact-info-card d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <h4 class="info-card-title mb-1">Chat on WhatsApp</h4>
                    ...
                    <div class="col-lg-7" data-aos="fade-up" data-aos-delay="150">
                        <div class="contact-form-wrapper p-4 p-md-5">
                            ...
                            <form class="contact-form" id="exportContactForm" method="POST" action="{{ route('contactPost') }}">
                                @csrf
                                @if (session('success'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-custom">
                                            <label for="orderQuantity" class="form-label-custom">Estimated Order
                                                Quantity</label>
                                            <select id="orderQuantity" name="order_quantity" class="form-select-custom" required>
