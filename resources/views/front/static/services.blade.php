...
@section('body_class', 'sercvice-page')
@section('content')
<!-- ── Page Hero ─────────────────────────────────────── -->
        ...
        <div class="swiper services-swiper py-2 pb-0" data-aos="fade-up" data-aos-delay="150">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide h-auto">
                    <div class="export-solution-card">
                        <div class="es-hover-bg"
                            style="background-image: url('https://plus.unsplash.com/premium_photo-1677695581626-2a75bdece138?q=80&w=1171&auto=format&fit=crop');">
                        </div>
                        <div class="es-hover-overlay"></div>
                        <div class="es-initial-content">
                            <div class="es-icon">
    ...
    <div class="container">
        ...
        <div class="row g-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4">
                <div class="why-card">
                    <div class="card-hover-overlay"
                        style="background-image: url('https://images.unsplash.com/photo-1660980041852-230420b8f99f?q=80&w=880&auto=format&fit=crop');">
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5" data-aos="fade-up">
                ...
                <h2 class="section-heading mb-3">Serving Buyers<br>Across Every Sector</h2>
