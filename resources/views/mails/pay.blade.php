...
@section('content')
                <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="25" border="0" align="center" width="550" class="container" style="background-color: #ffffff; border: 1px solid #f1f1f1;">
                    <td style="font-size: 28px;line-height: 1.4;font-family: 'Roboto', sans-serif;color: #ffffff;padding: 22px 50px;margin-bottom: 32px;background: #11ca79;text-align: center; font-weight: 400;" class="padding-copy">Order placed successfully
                    </td>
                    <tr>
                      <td style="padding-bottom:0px;">
                        <p>Hi <strong>{{$name}}</strong>,<br>
                          Thank you for placing an order with Indian Coin Shop. Your order details are given below</p>
                        <p>You will receive an email when your order is out for delivey. You can also track your order status in the profile section.</p> 
                        <p>
