...
@section('head')
    User Tried To Order (Pending)
@endsection
@section('content')
    <table class="header-row" width="508" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
        <tbody>
            <tr>
                <td class="header-row-td" width="508" style=" line-height: 19px; color: #353535; font-size: 14px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">Hi Admin,</td>
            </tr>
        </tbody>
    </table>
    <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="25" border="0" align="center" width="550" class="container" style="background-color: #ffffff; border: 1px solid #f1f1f1;">
        <td style="font-size: 28px;line-height: 1.4;font-family: 'Roboto', sans-serif;color: #ffffff;padding: 22px 50px;margin-bottom: 32px;background: #11ca79;text-align: center; font-weight: 400;" class="padding-copy">User Tried To Order (Pending)
        </td>
        <tr>
            ...
            <tbody>
                    ...
                    <tbody>
                      <tr>
                        <td valign="top" style="" align="left">
                          <p><strong>Pieces x Qty</strong></p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td valign="top" style="padding:5px 0px;">
                    {{$order->currency}} {{number_format($order->shop_tax, 2)}}
                  </td>
                </tr>
              <!-- /Price Calculation -->
              <!-- Price Calculation -->
              ...
              @endif
              @if($order->currency == '₹' && $order->shipping_tax > 0)
                <tr>
                  <td>
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tbody>
