...
@section('head')
    OTP Received From Indian Coin Shop
@endsection
@section('content')
    ...
    <div style="width: 100%; line-height: 19px; color: #353535; font-size: 14px;">Thank you for registering with Indian Coin Shop. To login and verify your email address, please use the following One-Time Password (OTP):</div>
    ...
    <div style="width: 100%; line-height: 19px; color: #353535; font-size: 14px;margin-bottom: 18px;">If you did not request this verification, please ignore this email or contact us at support@indiancoinshop.com if you have any concerns.</div>
@endsection